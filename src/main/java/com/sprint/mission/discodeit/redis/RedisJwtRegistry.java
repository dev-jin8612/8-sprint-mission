...
public class RedisJwtRegistry implements JwtRegistry {
    ...
    public void registerJwtInformation(JwtInformation jwtInformation) {
        String userKey = getUserKey(jwtInformation.getUser().id());
        String lockKey = jwtInformation.getUser().id().toString();
        ...
        eventPublisher.publishEvent(
                new UserLogInOutEvent(jwtInformation.getUser().id(), true)
        );
    }
    ...
    public void rotateJwtInformation(String refreshToken, JwtInformation newJwtInformation) {
        String userKey = getUserKey(newJwtInformation.getUser().id());
        String lockKey = newJwtInformation.getUser().id().toString();
